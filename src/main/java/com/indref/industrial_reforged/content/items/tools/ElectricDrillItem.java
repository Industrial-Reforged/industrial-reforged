...
public class ElectricDrillItem extends ElectricDiggerItem {
    public ElectricDrillItem(Properties properties, float attackSpeed, float baseAttackDamage, Tier tier, Supplier<EnergyTierImpl> energyTier, IntSupplier energyUsage, IntSupplier energyCapacity) {
