...
public class EpoxyResinFluid extends PDLFluid {
    public EpoxyResinFluid(String name) {
        super(name);
        this.fluidType = registerFluidType(FluidType.Properties.create(), new Vector4i(198, 155, 96, 255), FluidTemplates.WATER);
    }
