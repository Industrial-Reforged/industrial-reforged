...
public final class IRDataComponents {
    ...
    public static final Supplier<DataComponentType<Boolean>> MELTING = registerDataComponentType("melting",
            () -> builder -> builder.persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL));
    public static final Supplier<DataComponentType<Float>> MELTING_BARWIDTH = registerDataComponentType("melting_barwidth",
    ...
    public static final Supplier<DataComponentType<TapeMeasureData>> TAPE_MEASURE_DATA = registerDataComponentType("tape_measure_data",
            () -> builder -> builder.persistent(TapeMeasureData.CODEC).networkSynchronized(TapeMeasureData.STREAM_CODEC));
